...
create table usuarios(id int primary key auto_increment,
                        ...
                        Foreign Key (cargo_id) references cargos_ocultos (id)
                        );
...
create table respuestas_formulario(id int primary key auto_increment,
                                    ...
                                    Foreign key (estrato_socioeconomico_id) references estratos_socioeconomicos (id),
                                    Foreign key (grupo_sanguineo_id) references grupos_sanguineos (id),
                                    Foreign key (rh_id) references rhs (id),
                                    Foreign key (eps_id) references epss (id),
                                    Foreign key (fondo_pension_id) references fondos_pension (id),
                                    Foreign key (tipo_cohabitacion_id) references tipos_cohabitacion (id),
                                    ...
                                    Foreign Key (nivel_estudio_id) references niveles_educativos (id)
                                    );
